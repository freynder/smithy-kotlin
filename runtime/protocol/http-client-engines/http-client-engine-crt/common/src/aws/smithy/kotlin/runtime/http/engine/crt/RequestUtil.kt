...
internal fun mapCrtErrorCode(code: Int): HttpErrorCode = when (CRT.errorName(code)) {
    ...
    "AWS_IO_TLS_ERROR_NEGOTIATION_FAILURE", "AWS_IO_TLS_ERROR_NOT_NEGOTIATED" -> HttpErrorCode.TLS_NEGOTIATION_ERROR
    "AWS_ERROR_HTTP_UNSUPPORTED_PROTOCOL" -> HttpErrorCode.PROTOCOL_NEGOTIATION_ERROR
    "AWS_ERROR_HTTP_CONNECTION_CLOSED" -> HttpErrorCode.CONNECTION_CLOSED
